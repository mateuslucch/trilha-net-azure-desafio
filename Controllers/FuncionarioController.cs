...
public class FuncionarioController : ControllerBase
{
    ...
    private void GerarLog(Funcionario funcionarioBanco, TipoAcao acao)
    {
        var tableClient = GetTableClient();
        var funcionarioLog = new FuncionarioLog(funcionarioBanco, acao, funcionarioBanco.Departamento, Guid.NewGuid().ToString());
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        GerarLog(funcionario, TipoAcao.Inclusao);
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        GerarLog(funcionarioBanco, TipoAcao.Atualizacao);
    ...
    public IActionResult Deletar(int id)
    {
        ...
        GerarLog(funcionarioBanco, TipoAcao.Remocao);
